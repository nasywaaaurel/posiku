...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb" name="File Geodatabase Feature Class" format="" size="" type="Local Area Network" description="" mimeType=""/>
  </links>
  <fees></fees>
  ...
  <extent>
    <spatial minx="0" minz="0" maxy="0" dimensions="2" maxz="0" maxx="0" crs="EPSG:4326" miny="0"/>
    <temporal>
      <period>
        <start></start>
        <end></end>
